...
using ProiectPractica.DataModels.DTO;

namespace ProiectPractica.Controllers
{
    public class FriendRequestController : Controller
    {
        private SocialDbContext context;
        ...
        public IActionResult Index(int userId)
        {
            ...
            {
                return StatusCode (500, "A aparut o eroare la server!"); 
            }
        }
        [HttpPost("Sent")]
        public IActionResult Sent(int userId,int receiverId) 
        {
            ...
            catch(Exception ex) { return StatusCode(500, "Eroare la server!"); }
        }
        [HttpPost("Accept")]
        public IActionResult Accept(int senderId,int receiverId ) 
        {
            ...
            {
                return StatusCode(500, "Eroare la server!");
            }
        }
        [HttpDelete("Reject")]
        public IActionResult Reject(int senderId,int receiverId)
        {
            ...
            catch (Exception e) { return StatusCode(500, "Eroare la server!"); }
        }
    }
}
